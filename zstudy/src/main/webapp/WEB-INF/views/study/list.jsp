	...
	<div class="container" align="center">
		...
		<div class="col-lg-8" align="center">
	  	...
	  	<tr>
			...
			<c:if test="${isSuccess eq 'fail'}">이미 가입한 스터디 입니다.</c:if>
...
<%-- 							</c:if> --%>
							...
							<tr>
								<td>스터디 이름 : ${article.name}</td>
								<td>인원 수 : ${article.cntId}</td>
								<td><a href="${root}/article/join?name=${article.name }&id=${userinfo.userid}">스터디 가입</a></td>	
							</tr>
						</tbody>
					</table>
				</c:forEach>
